...
# # Use the specific word2vec embeddings
# Example.word2vec.load_embeddings(model.model.embeddings.word_embeddings, Example.word_vocab, device=device)
# print("id2word: ", Example.word_vocab.id2word)
print("Load word2vec embeddings finished ...")
...
# Should we only train the output layer?
def set_optimizer(model, args):
